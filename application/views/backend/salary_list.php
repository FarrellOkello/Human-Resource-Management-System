                                        ...
                                        <tbody>
                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $individual_info->basic.' Ushs'; ?></td>
                                                <td><?php echo $individual_info->loan.' Ushs'; ?></td>
                                                <td><?php echo $individual_info->total_days; ?></td>
                                                <!--<td><?php echo $individual_info->addition; ?></td>-->
                                                <td><?php echo $individual_info->diduction.' Ushs'; ?></td>
                                                <td><?php echo $individual_info->total_pay.' Ushs'; ?></td>
